...
Describe "Module is good to go" {
    Context "dbatools imports" {
        ...
        It "Module version is 2.7.6" {
            $module.Version | Should Be "2.7.6"
        }
        It "Module should import 684 commands" {
            (get-command -module dbatools -CommandType Function | Measure).Count | Should Be 684
        }
    }
}
